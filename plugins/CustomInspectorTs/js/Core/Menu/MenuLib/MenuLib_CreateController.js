    ...
    OnCreate() {
        ...
        this.addMoreControlClick = new csharp_1.FairyGUI.EventCallback1((event) => {
            try {
                ...
                return Tip_1.default.Inst.Show("偶尔有bug很正常，稍安勿躁，重新创建试试!!!");
            }
        });
    ...
    CallBack() {
        ...
        if (this.selectRES.Count) {
            ...
            if (this.selectRES.Count == 1)
                return Tip_1.default.Inst.Show("就选一个图片？？？直接拖不就行了？");
